  ...
  return (
    ...
    <section>
      ...
      <section className="flex flex-row gap-3 h-10">
        <button onClick={handleApprove}className="size-15 bg-green-500 font-semibold text-white ring rounded-full">Approve</button>
        <button onClick={handleDispprove}className="size-15 bg-red-500 font-semibold text-white ring rounded-full">Disapprove</button>
      </section>
    </div>
